          ...
          <div className="verCoworkingContainer">
            ...
            <div className="verCoworkingContenido">
              <div className="verDatosCoworking">
                <ul>
                  <li>
                    Ciudad: <b>{coworking.ciudad}</b>
                  </li>
                  <li>
                    Provincia: <b>{coworking.provincia}</b>
                  </li>
                  <li>
                    Direccion: <b>{coworking.direccion}</b>
                  </li>
                  <li>
                    Descripción: <b>{coworking.descripcion}</b>
                  </li>
                  <li>
                    Web: <b>{coworking.web}</b>
                  </li>
                  Servicios:
                  <li>
                    Wifi: <b>{coworking.wifi}</b>
                  </li>
                  <li>
                    Limpieza: <b>{coworking.limpieza}</b>
                  </li>
                  <li>
                    Parking: <b>{coworking.parking}</b>
                  </li>
                </ul>
              </div>
              ...
              <NavLink to={`/coworking/${id_coworking}/salas`}>
                Ver salas
              </NavLink>
